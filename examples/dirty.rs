...
use crate::nt_hive2::{ContainsHive, BaseBlock};
...
fn main() -> anyhow::Result<()> {
    ...
    let path_clean = path!(env!("CARGO_MANIFEST_DIR"), "tests", "data", "NewDirtyHive1.clean");
    let path_hive = path!(env!("CARGO_MANIFEST_DIR"), "tests", "data", "NewDirtyHive1", "NewDirtyHive");
    let path_log1 = path!(env!("CARGO_MANIFEST_DIR"), "tests", "data", "NewDirtyHive1", "NewDirtyHive.LOG1");
    let path_log2 = path!(env!("CARGO_MANIFEST_DIR"), "tests", "data", "NewDirtyHive1", "NewDirtyHive.LOG2");
    ...
    log::info!("write with offset 0x{:08x}", base_block.root_cell_offset().0);
